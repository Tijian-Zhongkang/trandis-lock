...
public class ClientPluginResponseProcessor extends PluginResponseProcessor {

    private final String applicationId;
    private final String address;

    public ClientPluginResponseProcessor(AbstractNettyRemoting client, String applicationId, String address,
    ...
    protected void setPluginParameters(IProcessorPlugin plugin, ChannelHandlerContext ctx, RpcMessage rpcMessage) {
        ...
        clientProcessorPlugin.setParameters(remoting, applicationId, address);
    }
