...
import com.xm.sanvanfo.common.ISerializerFactory;
...
public class ClassUtils {
    ...
    public static Object parseClassObject(Type type, String defaultString, ISerializerFactory factory, String serializeType) throws Exception {
        if(Class.class.isAssignableFrom(type.getClass())) {
            Class<?> clazz = (Class<?>)type;
            return parseClassObject(clazz, defaultString,
                    () -> factory.deserialize(defaultString, clazz, serializeType), () -> factory.deserialize(defaultString, LinkedHashMap.class, serializeType));
        }
        else {
            return factory.deserialize(defaultString, type, serializeType);
        }
    }

    public static Object parseClassObject(Class<?> clazz, String defaultString, ObjectMapper mapper) throws Exception {
        return parseClassObject(clazz, defaultString, ()->mapper.readValue(defaultString, clazz), ()->mapper.readValue(defaultString, LinkedHashMap.class));
    }

    @SuppressWarnings({"unchecked", "WeakerAccess"})
    public static Object parseClassObject(Class<?> clazz, String defaultString,
                                          SupplierException<Object> objectSupplier, SupplierException<LinkedHashMap> annotationSupplier) throws Exception {
        if(clazz.equals(String.class)) {
            return defaultString;
        }
        else if(clazz.equals(BigDecimal.class)) {
            double d =  Double.parseDouble(defaultString);
        ...
        else if(clazz.equals(Byte.class) || clazz.equals(byte.class) || clazz.equals(char.class)) {
            return Byte.parseByte(defaultString);
        }
        else if(clazz.equals(Double.class) || clazz.equals(double.class)) {
            return Double.parseDouble(defaultString);
        }
        else if(clazz.equals(Short.class) || clazz.equals(short.class)) {
            return Short.parseShort(defaultString);
        }
        else if(clazz.equals(Boolean.class) || clazz.equals(boolean.class)) {
            return Boolean.parseBoolean(defaultString);
        }
        else if(clazz.isEnum()) {
            return Enum.valueOf((Class)clazz, defaultString);
        }
        else if(clazz.isAnnotation()) {
            return annotationSupplier.get();//mapper.readValue(defaultString, LinkedHashMap.class);
        }
        return objectSupplier.get(); //mapper.readValue(defaultString, clazz);
    }
}
