...
public class CollectionUtils {
    ...
    public static Collection<?> createCollection(Class collectionType,  Class<?> elementType, int capacity) {
        ...
        } else if (elementType != null && EnumSet.class == collectionType) {
    ...
    public static <T> T findInList(List<T> list, Object obj, BiFunction<T, Object, Boolean> func) {
    ...
    public static <T> List<T> findListInList(List<T> list, Object obj, BiFunction<T, Object, Boolean> func) {
